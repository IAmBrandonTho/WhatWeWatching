...
<div class="streamQuality">
  <div class="mini" style="color: var(--muted); margin: 10px 0 8px">Canvas → WebRTC (Host view to Viewers)</div>

  <div class="sqRows">
    <label>Type</label>
    <div>
      <select id="streamTypeSel">
        <option value="p2p" selected>P2P</option>
        <option value="relay" disabled>Relay (future)</option>
      </select>
      <div class="pwSelect" id="streamTypePicker" style="display:none">
    ...
    <div>
      ...
      <div class="pwSelect" id="streamResPicker" style="display:none">
    ...
    <div>
      ...
      <div class="pwSelect" id="streamFpsPicker" style="display:none">
    ...
    <div>
      ...
      <div class="pwSelect" id="streamBitratePicker" style="display:none">
...
<script crossorigin="anonymous" defer="" src="app.v5.js?v=20260219.2" onerror="window.__pushJsErr && window.__pushJsErr('Failed to load script: '+(this.src||''))"></script>
