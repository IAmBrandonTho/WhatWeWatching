...
export default {
  async fetch(request, env) {
    ...
    const cors = {
      "Access-Control-Allow-Origin": allowedOrigins.has(origin) ? origin : "https://whatwewatching.pages.dev",
    ...
    if (url.pathname.startsWith("/ffmpeg/")) {
      ...
      const allowed = new Set(["814.ffmpeg.js","ffmpeg-core.js","ffmpeg-core.wasm","ffmpeg-core.worker.js","ffmpeg-core.mjs","ffmpeg-core.worker.mjs"]);
      ...
      // Required for COEP: allow the Pages origin to embed cross-origin ffmpeg assets
